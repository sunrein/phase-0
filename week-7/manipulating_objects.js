...
// The most difficult test to pass was figuring out they proper syntax for having an object within an object. I just kept playing around with , and ; in order to figure out how nesting them was supposed to work. I did have to google the proper syntax for nesting objects in JavaScript, but now it makes sense.

// How difficult was it to add and delete properties outside of the object itself?

// That also took a little playing around with. I had to make sure my notation was right. Figuring out how to add was initially harder than figuring out how to subtract, which followed a similar principle, so it was easier to figure out after I knew how to add.

// What did you learn about manipulating objects in this challenge?

// You need to let the program know what exactly you want to do and where you want it to access. Sometimes it is difficult ot remember syntax, which just means that you are pointing the program in the wrong direction. I have a better understanding how flow works in JavaScript, and how it manipulates objects.
